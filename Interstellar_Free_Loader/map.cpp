...
namespace Map {
	...
	PVOID ExtendMapA(Comm::Process &process, PBYTE base, LPCWSTR module) {
	...
	PVOID ExtendMap(Comm::Process &process, char* dllbytes, LPCWSTR module) {
	
		auto entryPoint = ExtendMapA(process, (PBYTE)dllbytes, module);
